...
**Prerequisites:** JDK 17+, MySQL 8+, Maven
...
## 📈 Development Stats
- 4,217+ lines of Java code
- 7 database tables
- 15+ REST API endpoints
- 3 real-time features (Chat, Notifications, Live Matching)
...
Every organ donation can save up to 8 lives. GiftLife exists to make the process faster, safer, and more transparent.
